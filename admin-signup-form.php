            ...
            <div class="form">
                <div class="form-content">
                        ...
                        <form action="process-employee-signup.php" method="post">
                            <div class="input-boxes">
                                <div class="input-box">
                                    ...
                                    <input type="text" name="first_name" placeholder="Enter you name" required>
                                </div>

                                <div class="input-box">
                                    <i class="fas fa-user-plus"></i>
                                    <input type="text" name="last_name" placeholder="Enter you last name" required>
                                </div>
                    ...
                    <div class="signup-form">
                        <div class="front">
                            <img src="imgs/back-customer-login.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
