...
<body>
    ...
    <div class="container" style="margin-top: 3rem;">
        <h3 class="text-warning text-uppercase text-center mb-3" style="color: #fbc257!important; background: #341413; padding: 10px; border-radius:10px;">Return cars on rent</h3>
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    while ($order = $orders_result->fetch_assoc()) {
                        ...
                        echo '<td class="align-middle">' . $order['customer_id'] . '</td>';
                        ...
                        echo '<td class="align-middle"><a href="process-return-car.php?order_id=' . $order['order_id'] . '" class="btn btn-outline-success">Return Car</a></td>';
