...
<body>
    ...
    <div class="container" style="margin-top: 3rem;">
        <h3 class="text-warning text-uppercase text-center mb-3" style="color: #fbc257!important; background: #341413; padding: 10px; border-radius:10px;">Your Current Order</h3>
